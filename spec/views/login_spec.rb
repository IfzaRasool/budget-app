...
RSpec.describe 'Login Validation', type: :system do
  describe 'Login page' do
    ...
    it 'should redirect to the categories page if the data is correct' do
      visit new_user_session_path
      User.create(name: 'mat', email: 'ifzarasoolarain@gmail.com', password: '123456')
      page.fill_in 'Email', with: 'ifzarasoolarain@gmail.com'
      page.fill_in 'Password', with: '123456'
      expect(page).to have_field('Email', with: 'ifzarasoolarain@gmail.com')
